package com.example.ssmspringboot.usermanage.utils;
...
/**
 * 显示格式：首页 上一页 1 2 3 4 5 下一页 尾页     自定义标签
 */
public class NavigationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException{
        ...
        //在JSP页面中可以直接使用out对象,而不用像这样用pageContext.getOut();来得到JspWriter对象.这样做得到的out1和JSP页面中封装的out对象是同
        ...
        try{
            ...
            for(int i = 1; i <= number && indexPage <= pageCount; indexPage++,i++){
                if(indexPage == page.getPage()){
                    writer.print("<li class=\"actice\"><a href=\"#\">"+indexPage+"<span class=\"sr-only\"></span></a></li>");  //??
                    continue;
                }
